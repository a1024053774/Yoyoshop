...
@WebServlet(name = "SearchServlet", value = "/index/search")
public class SearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Goods> goodsList = goodService.getGoodsListByKeywordPageQuery(keyword, page, size);
        request.setAttribute("goodList",goodsList);

        Long count = goodService.getGoodsCountByKeyWord(keyword);
