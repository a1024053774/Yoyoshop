package com.lanou.yoyoshop.util;
...
public class PageUtil {
	...
	public static String getPageTool(HttpServletRequest request, long total, int page, int size){
		...
		buf.append("<h2 style='display:inline;'>[共").append(total).append("条数据]</h2>\n");
		if (page >= pages) {
		...
		buf.append("<input type='text' class='layui-btn layui-btn-sm layui-btn-primary' style='display:inline;width:60px;' value=''/>");
