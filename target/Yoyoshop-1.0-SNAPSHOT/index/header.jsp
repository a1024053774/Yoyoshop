		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					<h1 class="navbar-brand"><a href="index">YOYO</a></h1>
				</div>
				<!--navbar-header-->
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
										...
										<div class="col-sm-12">
											...
											<ul class="multi-column-dropdown">
												<c:forEach var="type" items="${typeList}">
													<li><a class="list" href="goods?typeid=${type.id}&page=1&size=4">${type.name}</a></li>
												</c:forEach>
											</ul>
										</div>	
									</div>
						...
						<li><a href="/yoyo/admin.jsp" target="_blank">后台管理</a></li>
					</ul> 
					<!--/.navbar-collapse-->
				</div>
				<!--//navbar-header-->
			...
			<div class="header-info">
				...
				<div class="header-right cart">
					<a href="cart">
						<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"><span class="card_num">${cart.amount==null ? '' :cart.amount}</span></span>
					</a>
				</div>
